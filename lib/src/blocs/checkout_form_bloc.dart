...
class CheckoutFormBloc {
  ...
  void getCheckoutForm() async {
    ...
    if (response.statusCode == 200) {
      CheckoutFormData checkoutForm = checkoutDataFromJson(response.body);

      if(checkoutForm.fieldgroups.billing.any((element) => element.type == 'country')) {
        String? country = checkoutForm.fieldgroups.billing.firstWhere((element) => element.type == 'country').value;
        if(country != null) {
