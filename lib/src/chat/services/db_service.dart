...
class DBService {
  ...
  Stream<List<Conversation>> getConversations(String id, showDialogeOnError) {
    var _ref = _db
    ...
    //Don't delete this, This will give and erro in console with url to create indexes in firebase console.
    //click the url and create indexs
    _ref.get().catchError((e) {showDialogeOnError(e); print(e);});
