...
class ChatRoomList extends StatefulWidget {
  final String id;
  const ChatRoomList({Key? key, required this.id}) : super(key: key);
  @override
              ...
              return Column(
                children: [
                  ListTile(
                    ...
                    leading: appStateModel.user.id.toString() == _data[_index].userId ? SizedBox(width: 60, height: 60, child: CircleAvatar(radius: 30.0, foregroundImage: NetworkImage(appStateModel.user.avatarUrl))) : SizedBox(width: 60, height: 60,
                      child: CircleAvatar(
                        radius: 30,
