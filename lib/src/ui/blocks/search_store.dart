        ...
        Expanded(
          child: CupertinoTextField(
                ...
                decoration: BoxDecoration(
                  ...
                  color: Theme.of(context).appBarTheme.backgroundColor.toString() == 'Color(0xffffffff)' ? Colors.grey.withOpacity(0.1) : Theme.of(context).brightness == Brightness.dark ? Colors.grey.withOpacity(0.1) : Colors.white,
                ),
              ),
        ),
        SizedBox(width: 8),
          ...
          child: InkWell(
            ...
            child: Text(appStateModel.blocks.localeText.cancel,
                style: Theme.of(context).primaryTextTheme.subtitle1!.copyWith(
                  color: Theme.of(context).appBarTheme.backgroundColor.toString() == 'Color(0xffffffff)' ? Theme.of(context).hintColor : Theme.of(context).primaryIconTheme.color,
                )),
          ),
        ),
      ],
