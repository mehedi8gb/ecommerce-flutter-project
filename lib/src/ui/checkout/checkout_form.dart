  ...
  List<Widget> buildFrom(BuildContext context, AsyncSnapshot<CheckoutFormData> snapshot) {
    ...
    snapshot.data!.fieldgroups.billing.forEach((element) {
      ...
      if(element.label.isNotEmpty) {
        if((element.type.isEmpty || element.type == 'text') && element.label != 'Delivery Location') {
        ...
        if(snapshot.data != null && element.type == 'state' && snapshot.data!.fieldgroups.billing.any((element) => element.value == widget.checkoutFormBloc.selectedCountry) && snapshot.data!.fieldgroups.billing.firstWhere((element) => element.value == widget.checkoutFormBloc.selectedCountry).dotappOptions != null)
