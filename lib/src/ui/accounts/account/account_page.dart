...
class _AccountPageState extends State<AccountPage> {
  ...
  Widget build(BuildContext context) {
    return ScopedModelDescendant<AppStateModel>(
      ...
      return Theme(
        data: Theme.of(context).brightness == Brightness.light ? Theme.of(context).copyWith(
          textTheme: Theme.of(context).textTheme.copyWith(
            bodyText1: Theme.of(context).textTheme.bodyText1!.copyWith(
              color: model.blocks.settings.accountTheme.light.colorScheme.onSurface
            ),
          ),
          canvasColor: model.blocks.settings.accountTheme.light.canvasColor,
          primaryColor: model.blocks.settings.accountTheme.light.primaryColor,
          appBarTheme: AppBarTheme(
            color: model.blocks.settings.accountTheme.light.primaryColor,
            systemOverlayStyle: SystemUiOverlayStyle(
              statusBarBrightness: model.blocks.settings.accountTheme.light.primaryColor.isDark ? Brightness.dark : Brightness.light,
            ),
          ),
          dividerColor: model.blocks.settings.accountTheme.light.dividerColor,
        ) : Theme.of(context),
        child: Scaffold(
          ...
          child: TextButton(
            ...
            onPressed: () async {
              if(model.blocks.settings.socialLink.bottomText.contains('@') && model.blocks.settings.socialLink.bottomText.contains('.'))
                launch('mailto:' + model.blocks.settings.socialLink.bottomText);
              else {
