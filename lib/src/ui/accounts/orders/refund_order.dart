                                  ...
                                  child: TextFormField(
                                    validator: (value) {
                                      if (value != null && value.isNotEmpty && int.parse(value) > widget.order.lineItems[index].quantity) {
                                        return 'Value should not be more than ' + widget.order.lineItems[index].quantity.toString();
                                      }
                                      return null;
                                    },
                                ...
                                child: TextFormField(
                                  validator: (value) {
                                    if (value != null && value.isNotEmpty && double.parse(value) > double.parse(widget.order.lineItems[index].total)) {
                                      return 'Value should not be more than ' + widget.order.lineItems[index].total;
                                    }
                                    return null;
                                  },
                                  decoration: InputDecoration(
                          ...
                          child: PrimaryColorOverride(
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelText: 'Refund request reason',
                                errorMaxLines: 1,
                              ),
                              onSaved: (value) {
                                if(value != null)
