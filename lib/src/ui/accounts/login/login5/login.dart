...
class _Login5State extends State<Login5> {
            ...
            body: Builder(
                ...
                children: [
                  Container(
                    ...
                    child: CustomPaint(
                      painter: CurvePainter2(color: Theme.of(context).colorScheme.secondary),
                    ),
                  ),
                  Container(
                    height: MediaQuery.of(context).size.height,
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: isLoading ? Text(appStateModel.blocks.localeText.pleaseWait) : Text(appStateModel.blocks.localeText.signIn),
                            ),
                          ),
                          /*AccentButton(
                            onPressed: () => _submit(context),
  ...
  void _googleAuthentication(BuildContext context) async {
    ...
    if(googleUser != null)
    googleUser.authentication.then((value) => _loginGoogleUser(value.idToken!, googleUser, context));
  }
