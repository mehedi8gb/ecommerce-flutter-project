import 'dart:io';
import 'package:app/src/ui/accounts/login/otp_login/phone_number.dart';
                          ...
                          Center(
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Platform.isIOS && appStateModel.blocks.settings.appleLogin ? Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Card(
                                    color: Colors.white,
                                    elevation: 2,
                                    ...
                                    child: Card(
                                      ...
                                      child: Container(
                                        ...
                                        child: IconButton(
                                          ...
                                          onPressed: () {
                                            Navigator.of(context).push(
                                                MaterialPageRoute(builder: (context) => Material(child: PhoneLogin())));
                                          },
                                        ),
                                      ),
                                    ),
